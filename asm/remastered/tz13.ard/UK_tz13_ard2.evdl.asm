...
; - KGR[0] Script 40 (new): slide pickup handler, subscripts 11-16 give gift table idx 0x1B-0x20
; - KGR[0] Script 41-46 (new): Slide 1-6 actors, spawn until save_data[0x628+N-1] is set
...
; ────────────────────────────────────────────────────────────────────────
; Script 40  |  17 subscript(s)  |  KGR 0  (randomizer: slide pickup handler, copy of set 0 Script 1 subscripts 11-16)
; ────────────────────────────────────────────────────────────────────────
...
; ────────────────────────────────────────────────────────────────────────
; Script 41  |  11 subscript(s)  |  KGR 0  (randomizer: Slide 1 actor, copy of set 0 Script 8)
; ────────────────────────────────────────────────────────────────────────
...
@rando_slide1_2:
  ...
  0B000016  init_call       0xB               ; → Script 40 subscript 11
@rando_slide1_3:
  10000005  yield           0x10
  10000005  yield           0x10
  10000005  yield           0x10
...
; ────────────────────────────────────────────────────────────────────────
; Script 42  |  11 subscript(s)  |  KGR 0  (randomizer: Slide 2 actor, copy of set 0 Script 9)
; ────────────────────────────────────────────────────────────────────────
...
@rando_slide2_2:
  ...
  06000009  push            0x6
  28000015  push_cond       0x28
  0C000016  init_call       0xC               ; → Script 40 subscript 12
@rando_slide2_3:
  10000005  yield           0x10
  10000005  yield           0x10
  10000005  yield           0x10
...
; ────────────────────────────────────────────────────────────────────────
; Script 43  |  11 subscript(s)  |  KGR 0  (randomizer: Slide 3 actor, copy of set 0 Script 10)
; ────────────────────────────────────────────────────────────────────────
...
@rando_slide3_2:
  ...
  06000009  push            0x6
  28000015  push_cond       0x28
  0D000016  init_call       0xD               ; → Script 40 subscript 13
@rando_slide3_3:
  10000005  yield           0x10
  10000005  yield           0x10
  10000005  yield           0x10
...
; ────────────────────────────────────────────────────────────────────────
; Script 44  |  11 subscript(s)  |  KGR 0  (randomizer: Slide 4 actor, copy of set 0 Script 11)
; ────────────────────────────────────────────────────────────────────────
...
@rando_slide4_2:
  ...
  06000009  push            0x6
  28000015  push_cond       0x28
  0E000016  init_call       0xE               ; → Script 40 subscript 14
@rando_slide4_3:
  10000005  yield           0x10
  10000005  yield           0x10
  10000005  yield           0x10
...
; ────────────────────────────────────────────────────────────────────────
; Script 45  |  11 subscript(s)  |  KGR 0  (randomizer: Slide 5 actor, copy of set 0 Script 12)
; ────────────────────────────────────────────────────────────────────────
...
@rando_slide5_2:
  ...
  06000009  push            0x6
  28000015  push_cond       0x28
  0F000016  init_call       0xF               ; → Script 40 subscript 15
@rando_slide5_3:
  10000005  yield           0x10
  10000005  yield           0x10
  10000005  yield           0x10
...
; ────────────────────────────────────────────────────────────────────────
; Script 46  |  11 subscript(s)  |  KGR 0  (randomizer: Slide 6 actor, copy of set 0 Script 13)
; ────────────────────────────────────────────────────────────────────────
...
@rando_slide6_2:
  ...
  06000009  push            0x6
  28000015  push_cond       0x28
  10000016  init_call       0x10              ; → Script 40 subscript 16
@rando_slide6_3:
  10000005  yield           0x10
  10000005  yield           0x10
  10000005  yield           0x10
