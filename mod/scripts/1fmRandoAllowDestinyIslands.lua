...
local function allow_progress(raft_materials_item)
    local can_progress_day_1 = world_flags_address[game_version] + 0x305
    local can_progress_day_2 = world_flags_address[game_version] + 0x2F3
...
local function kairi_gift_unmissable()
    local kairi_gives_hint = world_flags_address[game_version] + 0x337
    local kairi_says_youre_hopeless = world_flags_address[game_version] + 0x338
