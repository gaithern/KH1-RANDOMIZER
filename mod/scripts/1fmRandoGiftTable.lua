...
local gift_location_ids = {
    ...
    [3] = {
        ...
        [0x1E] = -1,      -- Traverse Town Geppetto's House Cid Blueprint
        ...
        [0x26] = -1,      -- Traverse Town Mystical House Lord Fortune Event
        ...
        [0x31] = -1,      -- Traverse Town Defeat Guard Armor 100 Munny Reward
    ...
    [4] = {
        ...
        [0x0F] = -1,      -- Wonderland Lotus Forest Yellow Potion Flower via Painting
        [0x10] = 2656616, -- Wonderland Lotus Forest Yellow Elixir Flower via Painting
        ...
        [0x13] = -1,      -- Wonderland Lotus Forest Red Ether Flower Along Wall
