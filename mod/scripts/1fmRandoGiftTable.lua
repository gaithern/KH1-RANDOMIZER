...
local gift_location_ids = {
    ...
    [4] = {
        ...
        [0x14] = -1,      -- Wonderland Lotus Forest Blue Trinity in Alcove
        [0x15] = -1,      -- Wonderland Lotus Forest Blue Trinity by Moving Boulder
        [0x16] = -1,      -- Wonderland Tea Party Garden Left Cushioned Chair
        [0x17] = -1,      -- Wonderland Tea Party Garden Left Pink Chair
        [0x18] = -1,      -- Wonderland Tea Party Garden Right Yellow Chair
        [0x19] = -1,      -- Wonderland Tea Party Garden Left Gray Chair
        [0x1A] = -1,      -- Wonderland Tea Party Garden Right Brown Chair
