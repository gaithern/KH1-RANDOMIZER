...
local gift_location_ids = {
    [1] = {
        ...
        [0x04] = 2656705, -- Destiny Islands Seashore Log on Riku's Island (Day 1)
        [0x05] = 2656704, -- Destiny Islands Seashore Log under Bridge (Day 1)
        ...
        [0x0D] = -1,      -- Destiny Islands Seashore Defeat Riku (Day 1)
        [0x0E] = -1,      -- Destiny Islands Seashore Defeat Trio (Day 2)
        [0x0F] = -1,      -- Destiny Islands Seashore Gather Coconut (Day 2)
        [0x10] = -1,      -- Destiny Islands Seashore Talk to Kairi Potion Reward (Day 1)
        [0x11] = -1,      -- Destiny Islands Seashore Talk to Kairi Hi-Potion Reward (Day 1)
        [0x12] = -1,      -- Destiny Islands Cove Race Riku (Day 2)
        [0x13] = -1,      -- Destiny Islands Seashore Talk to Kairi Potion Reward (Day 2)
        [0x14] = -1,      -- Destiny Islands Seashore Talk to Kairi Hi-Potion Reward (Day 2)
    ...
    [3] = {
        ...
        [0x1A] = 2656306, -- Traverse Town Geppetto's House Yuffie Blueprint
        [0x1B] = 2656015, -- Traverse Town Kairi Secret Waterway Oathkeeper Event
        [0x1C] = 2656308, -- Traverse Town Geppetto's House Cactuar Blueprint
        [0x1D] = 2656305, -- Traverse Town Geppetto's House Aerith Blueprint
        [0x1E] = 2656303, -- Traverse Town Geppetto's House Cid Blueprint
        ...
        [0x26] = -1,      -- Traverse Town Magician's Study Lord Fortune Event
        ...
        [0x31] = 2656017, -- Traverse Town Defeat Guard Armor 500 Munny Reward
        ...
        [0x43] = 2656307, -- Traverse Town Geppetto's House Leon Blueprint
        [0x44] = -1,      -- Traverse Town Magician's Study Earthshine Reward
        [0x45] = -1,      -- Traverse Town Magician's Study Watergleam Reward
        [0x46] = -1,      -- Traverse Town Magician's Study Naturespark Reward
        [0x47] = -1,      -- Traverse Town Magician's Study Fireglow Reward
    ...
    [4] = {
        ...
        [0x0E] = 2656615, -- Wonderland Lotus Forest Yellow Potion Flower in Center Alcove
        [0x0F] = 2656624, -- Wonderland Lotus Forest Yellow Potion Flower Through Painting
        [0x10] = 2656616, -- Wonderland Lotus Forest Yellow Elixir Flower Through Painting
        [0x11] = 2656614, -- Wonderland Lotus Forest Red Ether Flower Across from Queen's Castle
        [0x12] = 2656617, -- Wonderland Lotus Forest Red Hi-Potion Flower via Lily Pads
        [0x13] = 2656625, -- Wonderland Lotus Forest Red Ether Flower Along Wall
        [0x14] = 2656603, -- Wonderland Lotus Forest Blue Trinity in Alcove
        [0x15] = 2656604, -- Wonderland Lotus Forest Blue Trinity by Moving Boulder
        [0x16] = 2656618, -- Wonderland Tea Party Garden Left Cushioned Chair
        [0x17] = 2656619, -- Wonderland Tea Party Garden Left Pink Chair
        [0x18] = 2656620, -- Wonderland Tea Party Garden Right Yellow Chair
        [0x19] = 2656621, -- Wonderland Tea Party Garden Left Gray Chair
        [0x1A] = 2656622, -- Wonderland Tea Party Garden Right Brown Chair
    ...
    [15] = {
        ...
        [0x2C] = -1,      -- Hollow Bastion Library Khama Vol. 8
        [0x2D] = -1,      -- Hollow Bastion Library Theon Vol. 6
        [0x2E] = -1,      -- Hollow Bastion Library Azal Vol. 3
        [0x2F] = -1,      -- Hollow Bastion Library Nahara Vol. 5
        [0x30] = -1,      -- Hollow Bastion Library Hafet Vol. 4
        ...
        [0x36] = 2656608, -- Hollow Bastion Great Crest Blue Trinity
