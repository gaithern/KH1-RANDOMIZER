    ...
    local function on_print_json(msg, extra)
        ...
        if extra.type == "ItemSend" or extra.type == "ItemCheat" then
            ...
            if receiver_id == ap:get_player_number() or sender_id == ap:get_player_number() then
                ...
                elseif receiver_id == ap:get_player_number() and kh1_lua_library.contains(remote_location_ids, location_id) then
                    line1 = "Obtained " .. item_name
                    line2 = nil
                elseif receiver_id == ap:get_player_number() and location_id == -1 then
                    line1 = "Obtained " .. item_name
                    line2 = "from server"
                end
                if line1 ~= nil then
